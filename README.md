...
Dingo resolves registered types recursively, keeps ownership rules explicit
through scopes and storage policies, and stays usable in plain C++ without
requiring intrusive macros or base classes.
...
- [Core Concepts](docs/core-concepts.md): scopes, storage, factories,
  interfaces, and multibindings.
...
- Non-intrusive registration of existing C++ types
- Configurable scopes and stored-instance forms
- Automatic constructor deduction with explicit factory overrides when needed
