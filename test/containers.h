...
struct static_container_traits_with_dynamic_rtti {
    template <typename TagT>
    using rebind_t = static_container_traits_with_dynamic_rtti<TagT>;
...
struct dynamic_container_traits_with_static_rtti {
    template <typename>
    using rebind_t = dynamic_container_traits_with_static_rtti;
