...
TEST(construct_dependency_test, auto_constructible_trait_defaults_and_opt_in) {
  ...
  static_assert(
      is_auto_constructible<issue_43::aggregate_dependencies<
          std::shared_ptr<issue_43::A>, std::shared_ptr<issue_43::B>>>::value);
  static_assert(
      !is_auto_constructible<issue_43::dependencies<
          std::shared_ptr<issue_43::A>, std::shared_ptr<issue_43::B>>>::value);
  static_assert(
      is_auto_constructible<issue_43::auto_dependencies<
          std::shared_ptr<issue_43::A>, std::shared_ptr<issue_43::B>>>::value);
}
