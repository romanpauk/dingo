...
struct explicit_dependency_first {};
struct explicit_dependency_second {};

struct explicit_dependencies_type {
  explicit_dependencies_type(explicit_dependency_first &,
                             explicit_dependency_second &)
      : value(-1) {}
  explicit_dependencies_type(explicit_dependency_second &,
                             explicit_dependency_first &)
      : value(17) {}
