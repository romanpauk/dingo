...
FEATURES = (
    ...
    Feature(
        ...
        checks=(
            ...
            "container.template register_type<dingo::scope<dingo::shared>, dingo::storage<reentrant_resolution_dependency>>();",
            "container.template register_type<dingo::scope<dingo::shared>, dingo::storage<reentrant_resolution_service>>(dingo::callable([&container, &reentrant_should_throw] {",
            "    auto& dependency = container.template resolve<reentrant_resolution_dependency&>();",
            "    if (reentrant_should_throw) {",
            "        throw rollback_exception();",
            "    }",
            "    return reentrant_resolution_service{std::addressof(dependency)};",
            "}));",
            "ASSERT_THROW(container.template resolve<reentrant_resolution_service&>(), rollback_exception);",
            ...
            "auto& reentrant_service = container.template resolve<reentrant_resolution_service&>();",
            "auto& reentrant_dependency = container.template resolve<reentrant_resolution_dependency&>();",
            "ASSERT_EQ(reentrant_service.dependency, std::addressof(reentrant_dependency));",
