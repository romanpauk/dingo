...
CONTAINERS = (
    ...
    container(
        name="runtime_container_indexed_vector",
        modes=frozenset({"runtime"}),
        container_type="dingo::runtime_container<indexed_vector_container_traits>",
        provides=frozenset({"indexed_container", "indexed_regression_container"}),
        support_headers=("matrix/support/indexed_containers.h",),
    ),
    container(
        name="container_indexed_vector",
        modes=frozenset({"runtime"}),
        container_type="dingo::container<indexed_vector_container_traits>",
        provides=frozenset({"indexed_container", "indexed_regression_container"}),
        support_headers=("matrix/support/indexed_containers.h",),
    ),
    container(
