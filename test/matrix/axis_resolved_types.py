    ...
    ResolvedType(
        ...
        checks=(
            ...
            (
                "invoke",
                (
                    "auto invoked = container.invoke([](dingo::request<value_type&, dingo::key<key_a>> dependency) {",
    ...
    ResolvedType(
        ...
        checks=(
            ...
            (
                "invoke",
                (
                    "auto invoked = container.invoke([](dingo::request<std::vector<std::shared_ptr<element_interface>>, dingo::key<key_a>> elements) {",
