...
TEST(type_conversion_test,
  ...
  ASSERT_THROW(
      (type_conversion<converter_variant_unrelated,
                       detail::lvalue_source<std::variant<
                           converter_variant_a, converter_variant_b>>>::
           apply(
  ...
  ASSERT_THROW(
      (type_conversion<converter_variant_unrelated *,
                       detail::pointer_source<std::variant<
                           converter_variant_a, converter_variant_b>>>::
           apply(pointer_factory, context, detail::make_pointer_source(&value),
                 describe_type<converter_variant_unrelated *>(),
                 describe_type<std::variant<converter_variant_a,
                                            converter_variant_b> *>())),
      type_not_convertible_exception);
}
