...
bool for_type(type_list<Head, Tail...>, const typename RTTI::type_index& type, Function&& fn) {
...
bool find_type(type_list<Head, Tail...>, const typename RTTI::type_index& type) {
    if (RTTI::template get_type_index<Head>() == type)
        return true;
    else
