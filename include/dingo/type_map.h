...
namespace dingo
{
    ...
    {
        dynamic_type_map(Allocator allocator)
            : values_(allocator)
        {}
    ...
    template < typename Tag, typename Key, typename Value > static_type_map_node_data< Tag, Value > static_type_map_node<Tag, Key, Value>::data;
    ...
    template < typename RTTI, typename Tag, typename Value, typename Allocator > struct static_type_map 
    {
        ...
        static_type_map(Allocator allocator)
            : nodes_()
            , size_()
        {}
