...
class static_container_impl<static_registry<Registrations...>, ParentContainer,
  ...
  using scope_type = static_binding_scope_view<state_type, Registrations...>;
...
public:
  ...
  using rtti_type = typename scope_type::rtti_type;
