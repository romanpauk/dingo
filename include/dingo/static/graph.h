...
template <typename Binding, typename DependencyBindings>
struct graph_node {
...
template <>
struct filter_resolved_dependency_bindings<void> {
    using type = type_list<>;
};

template <>
struct filter_resolved_dependency_bindings<type_list<>> {
    using type = type_list<>;
};
...
template <typename InterfaceBinding, typename StaticRegistry,
          bool PartialDependencies = false>
struct static_graph_node {
    ...
    using type = graph_node<InterfaceBinding, resolved_dependency_bindings_t<
                                                binding_model_type,
                                                typename StaticRegistry::
                                                    interface_bindings>>;
};

template <typename StaticRegistry, bool PartialDependencies>
struct static_graph_node<void, StaticRegistry, PartialDependencies> {
    using type = void;
};
...
struct static_binding_resolvable<Binding, StaticRegistry, Visiting, false>
    : static_bindings_resolvable<
          typename static_graph_node_t<Binding, StaticRegistry, false>::
              dependency_bindings,
...
struct static_bindings_resolvable<type_list<Bindings...>, StaticRegistry,
                                  Visiting>
    : std::bool_constant<
          (static_binding_resolvable<Bindings, StaticRegistry, Visiting>::value &&
           ...)> {};
...
template <typename StaticRegistry, bool PartialDependencies>
struct static_graph_nodes<type_list<>, StaticRegistry, PartialDependencies> {
    using type = type_list<>;
};

template <typename StaticRegistry, bool PartialDependencies>
struct static_graph_nodes<void, StaticRegistry, PartialDependencies> {
    using type = void;
};

template <typename... InterfaceBindings, typename StaticRegistry,
          bool PartialDependencies>
...
template <typename... DependencyBindings, typename StaticRegistry>
struct dependency_graph_nodes<type_list<DependencyBindings...>, StaticRegistry> {
    using type =
...
template <typename StorageTag> struct static_preserves_closure
    : std::false_type {};
...
template <typename StorageTag> struct static_storage_rollback_cost
    : std::integral_constant<std::size_t, 0> {};

template <> struct static_storage_rollback_cost<shared_cyclical>
...
template <typename StorageTag> struct static_storage_temporary_slot_cost
    : std::integral_constant<std::size_t, 0> {};

template <> struct static_storage_temporary_slot_cost<unique>
    : std::integral_constant<std::size_t, 1> {};

template <> struct static_storage_temporary_slot_cost<shared_cyclical>
    : std::integral_constant<std::size_t, 1> {};
...
template <typename StorageTag> struct static_storage_temporary_size
    : std::integral_constant<std::size_t, 0> {};

template <> struct static_storage_temporary_size<shared_cyclical>
...
template <typename StorageTag> struct static_storage_temporary_align
    : std::integral_constant<std::size_t, 0> {};

template <> struct static_storage_temporary_align<shared_cyclical>
...
using static_request_type_t =
    std::remove_cv_t<std::remove_reference_t<typename annotated_traits<
        Request>::type>>;
    ...
    std::max(
        {static_conversion_destructible_slots_v<
         ...
         static_binding_self_temporary_slot_cost_v<InterfaceBinding> != 0 &&
                 !std::is_trivially_destructible_v<typename InterfaceBinding::
                                                       binding_model_type::
                                                           storage_type::type>
             ? std::size_t{1}
             : std::size_t{0},
...
struct static_dependency_destructible_cost;

template <typename Dependencies>
struct static_dependency_temporary_slot_cost;

template <typename Dependencies>
struct static_dependency_temporary_size;

template <typename Dependencies>
struct static_dependency_temporary_align;
...
struct static_dependency_temporary_slot_cost<type_list<Dependencies...>>
    : std::integral_constant<
          std::size_t,
          (static_request_temporary_slot_cost_v<Dependencies> + ... +
           std::size_t{0})> {};
...
template <typename InterfaceBinding>
inline constexpr std::size_t static_binding_max_temporary_size_v =
    std::max(
        {static_dependency_temporary_size<
         ...
         static_conversion_temporary_size_v<
             typename InterfaceBinding::binding_model_type::storage_type>,
         sizeof(typename InterfaceBinding::binding_model_type::storage_type::
                    type),
...
template <typename InterfaceBinding>
inline constexpr std::size_t static_binding_max_temporary_align_v =
    std::max(
        {static_dependency_temporary_align<
         ...
         static_conversion_temporary_align_v<
             typename InterfaceBinding::binding_model_type::storage_type>,
         alignof(typename InterfaceBinding::binding_model_type::storage_type::
                     type),
...
struct static_dependency_peak_destructible_slots<
    ...
    : std::integral_constant<
          std::size_t,
          std::max(
              static_request_peak_destructible_slots<RequestHead, BindingHead,
                                                     StaticRegistry>::value +
                  static_dependency_retained_destructible_slots<
                      type_list<RequestTail...>, type_list<BindingTail...>,
                      StaticRegistry>::value,
...
struct static_request_retained_destructible_slots
    : std::integral_constant<
          std::size_t,
          static_binding_retained_destructible_slots<Binding,
                                                     StaticRegistry>::value +
              (static_request_uses_temporary_slot_v<Request> &&
...
struct static_request_peak_destructible_slots
    : std::integral_constant<
          std::size_t,
          std::max(static_binding_peak_destructible_slots<Binding,
                                                          StaticRegistry>::value,
                   static_request_retained_destructible_slots<
...
struct static_binding_peak_destructible_slots
    : std::integral_constant<
          std::size_t,
          std::max(static_dependency_peak_destructible_slots<
                       typename Binding::binding_model_type::dependencies_type::
                           type,
...
struct static_dependency_peak_temporary_slots<
    ...
    : std::integral_constant<
          std::size_t,
          std::max(
              static_request_peak_temporary_slots<RequestHead, BindingHead,
                                                  StaticRegistry>::value +
                  static_dependency_retained_temporary_slots<
                      type_list<RequestTail...>, type_list<BindingTail...>,
                      StaticRegistry>::value,
...
struct static_request_peak_temporary_slots
    : std::integral_constant<
          std::size_t,
          std::max(static_binding_peak_temporary_slots<Binding,
                                                       StaticRegistry>::value,
...
struct static_binding_peak_temporary_slots
    : std::integral_constant<
          std::size_t,
          std::max(static_dependency_peak_temporary_slots<
                       typename Binding::binding_model_type::dependencies_type::
                           type,
                       typename static_graph_node_t<Binding, StaticRegistry,
                                                    false>::dependency_bindings,
                       StaticRegistry>::value,
                   static_binding_retained_temporary_slots<
                       Binding, StaticRegistry>::value)> {};
...
template <typename StaticRegistry, bool PartialDependencies, bool Acyclic>
struct static_graph_max_preserved_closure_depth;

template <typename Binding, typename StaticRegistry,
          bool PartialDependencies = false>
struct static_graph_max_preserved_closure_depth_for;
...
template <typename Binding, typename StaticRegistry,
          bool PartialDependencies = false>
struct static_graph_max_destructible_slots_for;

template <typename Bindings>
struct static_graph_max_temporary_size_all;

template <typename StaticRegistry, bool Acyclic>
struct static_graph_max_temporary_size;

template <typename Bindings>
struct static_graph_max_temporary_align_all;
...
template <typename Binding, typename StaticRegistry,
          bool PartialDependencies = false>
struct static_graph_max_temporary_slots_for;
...
template <typename... Bindings, typename StaticRegistry, bool PartialDependencies>
struct static_graph_max_preserved_closure_depth_all<
    type_list<Bindings...>, StaticRegistry, PartialDependencies>
    : std::integral_constant<
          std::size_t,
          std::max({static_graph_max_preserved_closure_depth_for<
                        Bindings, StaticRegistry, PartialDependencies>::value...,
                    std::size_t{0}})> {};

template <typename Binding, typename StaticRegistry, bool PartialDependencies>
struct static_graph_max_preserved_closure_depth_for
    : std::integral_constant<
          std::size_t,
          static_binding_preserved_closure_cost_v<Binding> +
              static_graph_max_preserved_closure_depth_all<
                  typename static_graph_node_t<Binding, StaticRegistry,
                                               PartialDependencies>::
                      dependency_bindings,
                  StaticRegistry, PartialDependencies>::value> {};

template <typename StaticRegistry, bool PartialDependencies>
struct static_graph_max_preserved_closure_depth_for<void, StaticRegistry,
                                                    PartialDependencies>
    : std::integral_constant<std::size_t, 0> {};
...
struct static_graph_max_destructible_slots_all<
    ...
    : std::integral_constant<
          std::size_t,
          std::max({static_graph_max_destructible_slots_for<
                        Bindings, StaticRegistry, PartialDependencies>::value...,
                    std::size_t{0}})> {};
...
struct static_graph_max_destructible_slots_for
    : std::integral_constant<
          std::size_t,
          static_binding_destructible_slot_cost_v<Binding> +
...
template <typename StaticRegistry, bool PartialDependencies>
struct static_graph_max_destructible_slots_for<void, StaticRegistry,
                                               PartialDependencies>
    : std::integral_constant<std::size_t, 0> {};

template <typename Binding, typename StaticRegistry>
struct static_graph_max_destructible_slots_for<Binding, StaticRegistry, false>
...
template <typename StaticRegistry, bool PartialDependencies>
struct static_graph_max_destructible_slots<StaticRegistry, PartialDependencies,
                                           false>
    : std::integral_constant<std::size_t, 0> {};
...
struct static_graph_max_temporary_slots_all<type_list<Bindings...>,
    ...
    : std::integral_constant<
          std::size_t,
          std::max({static_graph_max_temporary_slots_for<
                        Bindings, StaticRegistry, PartialDependencies>::value...,
                    std::size_t{0}})> {};
...
struct static_graph_max_temporary_slots_for
    : std::integral_constant<
          std::size_t,
          static_binding_temporary_slot_cost_v<Binding> +
...
template <typename StaticRegistry, bool PartialDependencies>
struct static_graph_max_temporary_slots_for<void, StaticRegistry,
                                            PartialDependencies>
    : std::integral_constant<std::size_t, 0> {};

template <typename Binding, typename StaticRegistry>
struct static_graph_max_temporary_slots_for<Binding, StaticRegistry, false>
    : static_binding_peak_temporary_slots<Binding, StaticRegistry> {};

template <typename StaticRegistry, bool PartialDependencies>
struct static_graph_max_temporary_slots<StaticRegistry, PartialDependencies,
                                        false>
    : std::integral_constant<std::size_t, 0> {};
...
struct graph_visit_complete;

template <typename RecurseResult, typename Binding>
struct graph_visit_complete<RecurseResult, Binding, true> {
    using type = graph_visit_result<
        true, type_list_cat_t<typename RecurseResult::visited, type_list<Binding>>,
        type_list_cat_t<typename RecurseResult::order, type_list<Binding>>>;
};

template <typename RecurseResult, typename Binding>
struct graph_visit_complete<RecurseResult, Binding, false> {
    using type = graph_visit_result<false, typename RecurseResult::visited, void>;
};

template <typename Bindings, typename StaticRegistry, typename Visiting,
          typename Visited, bool PartialDependencies>
...
template <typename Head, typename... Tail, typename StaticRegistry,
          typename Visiting, typename Visited, bool PartialDependencies>
struct graph_visit_all<type_list<Head, Tail...>, StaticRegistry, Visiting,
                       Visited, PartialDependencies> {
  private:
    using head_result =
  ...
  public:
    using type = typename graph_visit_merge<
        head_result, tail_result,
        head_result::acyclic && tail_result::acyclic>::type;
};

template <typename Binding, typename StaticRegistry, typename Visiting,
          typename Visited, bool PartialDependencies, bool InVisiting,
          bool InVisited>
...
struct graph_visit_one_impl<Binding, StaticRegistry, Visiting, Visited,
                            PartialDependencies, true, false> {
...
template <typename Binding, typename StaticRegistry, typename Visiting,
          typename Visited, bool PartialDependencies>
struct graph_visit_one_impl<Binding, StaticRegistry, Visiting, Visited,
                            PartialDependencies, false, true> {
    using type = graph_visit_result<true, Visited, type_list<>>;
};
...
template <typename Binding, typename StaticRegistry, typename Visiting,
          typename Visited, bool PartialDependencies>
struct graph_visit_one_impl<Binding, StaticRegistry, Visiting, Visited,
                            PartialDependencies, false, false> {
  private:
    using node =
        static_graph_node_t<Binding, StaticRegistry, PartialDependencies>;

    using recurse_result = typename graph_visit_all<
        typename node::dependency_bindings, StaticRegistry,
        type_list_cat_t<Visiting, type_list<Binding>>, Visited,
        PartialDependencies>::type;

  public:
    using type =
        typename graph_visit_complete<recurse_result, Binding,
...
struct graph_visit_one {
    using type = typename graph_visit_one_impl<
        Binding, StaticRegistry, Visiting, Visited, PartialDependencies,
...
struct basic_static_execution_traits {
  private:
    using topology =
        basic_static_graph_topology_analysis<StaticRegistry,
                                             PartialDependencies>;
  ...
  public:
    ...
    static constexpr std::size_t max_destructible_slots =
        static_graph_max_destructible_slots<StaticRegistry, PartialDependencies,
                                            acyclic>::value;
    static constexpr std::size_t max_temporary_slots =
        static_graph_max_temporary_slots<StaticRegistry, PartialDependencies,
                                         acyclic>::value;
...
using graph_analysis =
    basic_static_graph_topology_analysis<StaticRegistry, PartialDependencies>;

template <typename StaticRegistry, bool PartialDependencies = false>
using execution_traits =
    basic_static_execution_traits<StaticRegistry, PartialDependencies>;
...
struct static_graph<static_registry<Registrations...>, void>
    ...
    using topological_bindings =
        typename detail::graph_analysis<static_registry_type>::
            topological_bindings;
