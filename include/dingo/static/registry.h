...
private:
  ...
  using requests = binding_request_types<raw_interface_type, storage_type>;
  using base_types = type_list_cat_t<
      rebind_leaf_t<typename requests::value_types, raw_interface_type>,
      rebind_leaf_t<typename requests::lvalue_reference_types,
                    raw_interface_type>,
      rebind_leaf_t<typename requests::rvalue_reference_types,
                    raw_interface_type>,
      rebind_leaf_t<typename requests::pointer_types, raw_interface_type>>;
