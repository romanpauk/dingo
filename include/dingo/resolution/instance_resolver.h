...
struct shared_instance_resolver;

template <typename RTTI, typename Type, typename Storage>
struct shared_instance_resolver<RTTI, Type, Storage, false> {
    ~shared_instance_resolver() { closure_.reset(); }
...
template <typename RTTI, typename Type, typename Storage>
struct shared_instance_resolver<RTTI, Type, Storage, true>
    : conversion_cache<resolver_conversion_types_t<Type, Storage>> {
    using conversion_cache_type =
        conversion_cache<resolver_conversion_types_t<Type, Storage>>;
  ...
  private:
    auto& conversions() {
        return static_cast<conversion_cache_type&>(*this);
    }
...
template <typename RTTI, typename Type, typename Storage,
          bool HasConversionCache>
struct external_instance_resolver;

template <typename RTTI, typename Type, typename Storage>
struct external_instance_resolver<RTTI, Type, Storage, false> {
    template <typename Context, typename Container>
    decltype(auto) resolve(Context& context, Container& container,
                           Storage& storage) {
        return storage.resolve(context, container);
...
template <typename RTTI, typename Type, typename Storage>
struct external_instance_resolver<RTTI, Type, Storage, true>
    : conversion_cache<resolver_conversion_types_t<Type, Storage>> {
    using conversion_cache_type =
        conversion_cache<resolver_conversion_types_t<Type, Storage>>;
...
template <typename RTTI, typename Type, typename Storage>
struct instance_resolver<RTTI, Type, Storage, unique> {
    template <typename Context, typename Container>
    decltype(auto) resolve(Context& context, Container& container,
                           Storage& storage) {
        return storage.resolve(context, container);
...
template <typename RTTI, typename Type, typename Storage>
struct instance_resolver<RTTI, Type, Storage, shared>
    : detail::shared_instance_resolver<
          RTTI, Type, Storage,
          detail::resolver_has_conversion_cache_v<
              detail::resolver_conversion_types_t<Type, Storage>>> {};

template <typename RTTI, typename Type, typename Storage>
struct instance_resolver<RTTI, Type, Storage, shared_cyclical>
    : instance_resolver<RTTI, Type, Storage, external> {};

template <typename RTTI, typename Type, typename Storage>
struct instance_resolver<RTTI, Type, Storage, external>
    : detail::external_instance_resolver<
          RTTI, Type, Storage,
          detail::resolver_has_conversion_cache_v<
              detail::resolver_conversion_types_t<Type, Storage>>> {};
